                ...
                <div class="row">
                    <div class="col-xs-12">
                            ...
                            <form id="frmSearch" method="GET" action="" class="frmSearch" name="frmSearch">
                                <div class="panel-body panel-search">
                                    <div class="form-group col-lg-2">
                                        ...
                                        <div>
                                            <input type="text" class="form-control input-sm" name="branch_name" @if(isset($search['branch_name']) && $search['branch_name'] !='')value="{{$search['branch_name']}}"@endif>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-2">
                                ...
                                <div class="panel-footer text-right">
                                    <a class="btn btn-default btn-sm" class="reset" href="{{route('admin.branch')}}"><i class="fa fa-recycle"></i>Bỏ lọc</a>
                                    <a class="btn btn-danger btn-sm" href="{{FuncLib::getBaseUrl()}}admin/branch/edit"><i class="ace-icon fa fa-plus-circle"></i>Thêm mới</a>
                        ...
                        @if(sizeof($data) > 0)
                            ...
                            @endif
                            <br>
                            <form id="formListItem" method="POST" action="{{FuncLib::getBaseUrl()}}admin/branch/delete" class="formListItem" name="txtForm">
                                <table class="table table-bordered table-hover">
                                    ...
                                    @foreach($data as $k=>$item)
                                        <tr>
                                            ...
                                            <td>
                                                <label class="pos-rel">
                                                    <input class="ace checkItem" name="checkItem[]" value="{{$item['branch_id']}}" type="checkbox">
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>
                                            <td><a title="{{$item->branch_name}}" href="">{{$item['branch_name']}}</a></td>
                                            <td>{{date('d/m/Y', $item['branch_created'])}}</td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="{{FuncLib::getBaseUrl()}}admin/branch/edit/{{$item['branch_id']}}" title="Cập nhật">
