        ...
        <div class="main-content-inner">
            <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">@if($id==0)Thêm mới @else Sửa @endif Ngành</li>
                </ul>
            </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="controls">
                                                                    <input type="text" class="form-control input-sm" name="branch_name" value="@if(isset($data['branch_name'])){{$data['branch_name']}}@endif">
                                                                </div>
                                                            </div>
                                                        </div>
