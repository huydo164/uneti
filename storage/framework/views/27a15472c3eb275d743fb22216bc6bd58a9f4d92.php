        ...
        <div class="main-content-inner">
            <div class="breadcrumbs breadcrumbs-fixed" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Quản lý ngành</li>
                </ul>
            </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                            ...
                            <form id="frmSearch" method="GET" action="" class="frmSearch" name="frmSearch">
                                <div class="panel-body panel-search">
                                    <div class="form-group col-lg-2">
                                        ...
                                        <div>
                                            <input type="text" class="form-control input-sm" name="branch_name" <?php if(isset($search['branch_name']) && $search['branch_name'] !=''): ?>value="<?php echo e($search['branch_name']); ?>"<?php endif; ?>>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-2">
                                        <label class="control-label">Trạng thái</label>
                                        <div>
                                            <select name="branch_status" class="form-control input-sm">
                                ...
                                <div class="panel-footer text-right">
                                    <a class="btn btn-default btn-sm" class="reset" href="<?php echo e(route('admin.branch')); ?>"><i class="fa fa-recycle"></i>Bỏ lọc</a>
                                    <a class="btn btn-danger btn-sm" href="<?php echo e(FuncLib::getBaseUrl()); ?>admin/branch/edit"><i class="ace-icon fa fa-plus-circle"></i>Thêm mới</a>
                        ...
                        <?php if(sizeof($data) > 0): ?>
                            ...
                            <?php endif; ?>
                            <br>
                            <form id="formListItem" method="POST" action="<?php echo e(FuncLib::getBaseUrl()); ?>admin/branch/delete" class="formListItem" name="txtForm">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <label class="pos-rel">
                                                    <input class="ace checkItem" name="checkItem[]" value="<?php echo e($item['branch_id']); ?>" type="checkbox">
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>
                                            <td><a title="<?php echo e($item->branch_name); ?>" href=""><?php echo e($item['branch_name']); ?></a></td>
                                            <td><?php echo e(date('d/m/Y', $item['branch_created'])); ?></td>
                                            <td>
                                                <?php if($item['branch_status'] == '1'): ?>
                                            ...
                                            <td>
                                                <a href="<?php echo e(FuncLib::getBaseUrl()); ?>admin/branch/edit/<?php echo e($item['branch_id']); ?>" title="Cập nhật">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\project.vn\uneti1\app\Modules/Admin/Views/branch/list.blade.php ENDPATH**/ ?>