                                            ...
                                            <div class="tab-pane panelDetail active" id="tabNoiDung" role="tabpanel">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="form-control input-sm" name="role_title" value="<?php if(isset($data['role_title'])): ?><?php echo e($data['role_title']); ?><?php endif; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="form-control input-sm" name="role_order_no" value="<?php if(isset($data['role_order_no'])): ?><?php echo e($data['role_order_no']); ?><?php endif; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
...
<?php echo $__env->make('Admin::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\project.vn\uneti1\app\Modules/Admin/Views/userRole/add.blade.php ENDPATH**/ ?>