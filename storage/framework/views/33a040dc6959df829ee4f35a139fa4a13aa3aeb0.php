                ...
                <div class="row">
                    <div class="col-xs-12">
                            ...
                            <form id="frmSearch" method="GET" action="" class="frmSearch" name="frmSearch">
                                <div class="panel-body panel-search">
                                    <div class="form-group col-lg-2">
                                        ...
                                        <div>
                                            <input type="text" class="form-control input-sm" name="form_title" <?php if(isset($search['form_title']) && $search['form_title'] !=''): ?>value="<?php echo e($search['form_title']); ?>"<?php endif; ?>>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-2">
                                ...
                                <div class="panel-footer text-right">
                                    <a class="btn btn-default btn-sm" class="reset" href="<?php echo e(route('admin.form')); ?>"><i class="fa fa-recycle"></i>Bỏ lọc</a>
                                    <a class="btn btn-danger btn-sm" href="<?php echo e(FuncLib::getBaseUrl()); ?>admin/form/edit"><i class="ace-icon fa fa-plus-circle"></i>Thêm mới</a>
                        ...
                        <?php if(sizeof($data) > 0): ?>
                            ...
                            <?php endif; ?>
                            <br>
                            <form id="formListItem" method="POST" action="<?php echo e(FuncLib::getBaseUrl()); ?>admin/form/delete" class="formListItem" name="txtForm">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <label class="pos-rel">
                                                    <input class="ace checkItem" name="checkItem[]" value="<?php echo e($item['form_id']); ?>" type="checkbox">
                                                    <span class="lbl"></span>
                                                </label>
                                            </td>
                                            <td><a title="<?php echo e($item->form_title); ?>" href=""><?php echo e($item['form_title']); ?></a></td>
                                            <td><?php echo e(date('d/m/Y', $item['form_created'])); ?></td>
                                            <td>
                                                <?php if($item['form_status'] == '1'): ?>
                                            ...
                                            <td>
                                                <a href="<?php echo e(FuncLib::getBaseUrl()); ?>admin/form/edit/<?php echo e($item['form_id']); ?>" title="Cập nhật">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Admin::layout.html', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\project.vn\uneti1\app\Modules/Admin/Views/form/list.blade.php ENDPATH**/ ?>