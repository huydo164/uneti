        ...
        <div class="modal-content bgIndex">
            ...
            <div class="content-popup-body">
                <div class="contentSupport">
                    <form id="formSendContact" method="POST" class="formSendContact box-form-register" name="txtForm" action="<?php echo e(URL::route('site.pageContactPost')); ?>">
...
<?php /**PATH D:\wamp64\www\project.vn\uneti1\app\Modules/Statics/Views/content/component/popup-support.blade.php ENDPATH**/ ?>